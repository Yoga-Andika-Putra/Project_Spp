                                    ...
                                    <span class="badge badge-success badge-rounded float-right">{{ $history->created_at->diffforHumans() }}</span>
                                        ...
                                        <span class="m-b-15 d-block">
                                             <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">SPP Bulan <b  class="text-capitalize text-bold">{{ $history->spp->bulan }} {{ $history->spp->tahun }}</b></li>
                                                <li class="list-group-item">Nominal SPP Rp.{{ $spp = $history->spp->nominal }}</li>
                                                <li class="list-group-item">Bayar Rp.{{ $bayar = $history->jumlah_bayar }}</li>
                                                <li class="list-group-item">Status <b class="text-capitalize">{{ $status = $history->status }}</b></li>
