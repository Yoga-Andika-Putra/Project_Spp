...
Route::resource('/dashboard/profil', 'ProfilController');
...
Route::get('/dashboard/siswa/profil', 'SiswaLoginController@profil');
Route::get('/siswa/logout', 'SiswaLoginController@logout');
Route::get('/login/petugas', 'PetugasController@store');
