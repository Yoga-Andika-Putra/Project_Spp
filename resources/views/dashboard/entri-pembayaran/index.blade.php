                ...
                <form method="post" action="{{ url('dashboard/pembayaran') }}">
                  @csrf
                           ...
                           @else
                              <option value="">Silahkan Pilih</option>
                                 @foreach($spp as $value)
                                    <option value="{{ $value->id }}">{{ 'Tahun '.$value->tahun.' - '.'Bulan '.$value->bulan.' - '.'Rp.'.$value->nominal }}</option>
                                 @endforeach
                           @endif
                       </select>
                     </div>
                     ...
                     <div class="form-group">
                       ...
                       <input type="number" class="form-control @error('jumlah_bayar') is-invalid @enderror" name="jumlah_bayar" placeholder="Rp. ">
                  ...
                  <div class="table-responsive mb-3">
								...
								@foreach($pembayaran as $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->spp->bulan }}</td>
                                            <td>{{ $value->spp->nominal }}</td>
                                            <td>{{ $value->jumlah_bayar + $value->transaksi }}</td>
                                            <td>{{ $value->status }}</td>
